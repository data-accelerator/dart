...
func TestParseFlagsDefaults(t *testing.T) {
	...
	if _, err := parseFlags([]string{"-listen", "127.0.0.1:0", "-cache-size", "1048576"}, io.Discard); err != nil {
...
func TestRunErrors(t *testing.T) {
	...
	if err := run([]string{"-chunk-size", "10", "-block-size", "16", "-cache-dir", t.TempDir()}, io.Discard); err == nil {
...
func TestPrefixCollidingWithRegistryPathRejected(t *testing.T) {
	...
	if _, err := parseFlags([]string{"-registry", "https://example.com", "-prefix", "v2"}, &out); err == nil {
	...
	if _, err := parseFlags([]string{"-prefix", "v2"}, &out); err != nil {
